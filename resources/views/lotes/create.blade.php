...
@section('content')
    <div class="mb-4">
        ...
        <p class="text-muted mb-0">
            Un lote agrupa productos del <strong>mismo productor</strong>, cosechados el <strong>mismo día</strong>, con el <strong>mismo tipo</strong> y características similares (calidad indicada en la descripción).
        </p>
    </div>
