...
@section('title', 'Registrar responsable de transporte')
...
@section('content')
    <div class="mb-4">
        <h1 class="h3 mb-2 d-flex align-items-center gap-2">
            <span aria-hidden="true">🚚</span> Registrar responsable de transporte
        </h1>
        <p class="text-muted mb-0">Completa los datos personales y de licencia del responsable.</p>
    </div>
